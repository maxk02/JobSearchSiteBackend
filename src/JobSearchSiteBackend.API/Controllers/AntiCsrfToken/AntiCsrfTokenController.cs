...
namespace JobSearchSiteBackend.API.Controllers.AntiCsrfToken;

[ApiController]
[Route("api/anti-csrf-token")]
public class AntiCsrfTokenController(IMapper mapper) : ControllerBase
{
    [HttpPost]
