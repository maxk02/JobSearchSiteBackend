...
using API.Persistence.EfCore.Context;
using Shared.Result;

namespace API.Persistence.EfCore.Repositories.Shared;

public class RepositoryBase<T> : IRepository<T> where T : class, IEntityWithId
{
